...
namespace Parser_Project_4
{
    class Fietsendiefstal
    {
     ...
     Type.Missing, Type.Missing);
            ...
            string tables = (char)34 + "Voorval nummer" + (char)34 + " ," +  (char)34 + "Kennisname" + (char)34 + " ," + (char)34 + "MK" + (char)34 + " ," + (char)34 + "MK omschrijving" + (char)34 + " ," + (char)34 + "Poging" + (char)34 + " ," + (char)34 + "District" + (char)34 + " ," + (char)34 + "Werkgebied" + (char)34 + " ," + (char)34 + "Plaats" + (char)34 + " ," + (char)34 + "Buurt" + (char)34 + " ," + (char)34 + "Straat" + (char)34 + " ," + (char)34 + "Begin dagsoort" + (char)34 + " ," + (char)34 + "Begindatum" + (char)34 + " ," + (char)34 + "Begintijd" + (char)34 + " ," + (char)34 + "Eind dagsoort" + (char)34 + " ," + (char)34 + "Einddatum" + (char)34 + " ," + (char)34 + "Eindtijd" + (char)34 + " ," + (char)34 + "Gemiddelde jaar" + (char)34 + " ," + (char)34 + "Gemiddelde maand" + (char)34 + " ," + "Gemiddelde dagsoort" + (char)34 + "," + (char)34 + "Gemiddelde dagdeel (6 uren)" + (char)34 + "," + (char)34 + "Trefwoord" + (char)34 + "," + (char)34 + "object" + (char)34 +  "," + (char)34 + "merk" + (char)34 + "," + (char)34 + "type" + (char)34 +  "," + (char)34 + "kleur" + (char)34 ;
            ...
            for(int i = 1; i < 20; i++)
            {
                query += "INSERT INTO fietsendiefstal(" + tables + ")  VALUES (";
                for(int j = 1; j <= 25; j++)
                {
                    query += (char)34;
                    query += sheet.Cells[i, j].value;
                    query += (char)34 + " ,";  
