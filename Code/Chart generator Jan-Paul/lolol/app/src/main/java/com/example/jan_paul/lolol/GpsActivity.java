...
import Design_Patterns.None;
import Design_Patterns.Option;
import Design_Patterns.OptionVisitor;
import Design_Patterns.Some;

/**
 * Created by jan-paul on 5-7-2016.
 */
        ...
        FindAdressButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if(parsable){
                    ...
                    ArrayAdapter<String> adapter = new ArrayAdapter<String>(GpsActivity.this,
